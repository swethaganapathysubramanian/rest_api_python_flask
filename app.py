...
app.config['JWT_SECRET_KEY'] = 'nachos'
app.config['MAIL_SERVER'] = 'smtp.mailtrap.io'
app.config['MAIL_PORT'] = 2525
app.config['MAIL_USERNAME'] = '99a38a9e881e61'
app.config['MAIL_PASSWORD'] = '771975b1d138a3'
...
def retrive_password(email: str):
    ...
    if user:
        msg = Message('Your password is ' + user.password,
                      sender="api@flask.com", recipients=[email])
        mail.send(msg)
...
@app.route('/add_planets/', methods=['POST'])
@jwt_required
def add_planets():
    ...
    if planet:
        ...
        new_planet = Planet(planet_name=planet_name, planet_type=planet_type, mass=mass,
                            home_star=home_star, radius=radius, distance=distance)
...
class PlanetSchema(ma.Schema):
    class Meta:
        fields = ('id', 'planet_name', 'planet_type',
